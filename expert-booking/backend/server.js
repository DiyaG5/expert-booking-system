...
const io = new Server(server, {
  cors: {
    origin: [process.env.CLIENT_URL || 'http://localhost:3000', 'https://expert-booking-system-f1ggvqm4a-diyag5s-projects.vercel.app', 'https://expert-booking-system-livid.vercel.app'],
